...
const Home: React.FC = () => {
    return (
        <div className="pb-0 overflow-x-hidden pt-0 mt-[-80px]"> {/* Adjusted for navbar transparency if needed */}
            <Hero />
            ...
            <section className="mt-40 mb-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-6xl font-black text-gray-900 leading-tight">Trải nghiệm du lịch <br /> thế hệ mới</h2>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
                        <div>
                            <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-black uppercase tracking-widest mb-8">
                                <Zap className="w-4 h-4 mr-2" /> Powered by AI
                            </div>
                            <h2 className="text-5xl md:text-7xl font-black text-white mb-10 leading-[1.1] tracking-tighter">
                                Lên kế hoạch <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-teal-400 to-blue-500">Thông minh hơn</span>
                            </h2>
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="flex items-center space-x-4 mb-10">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500 to-teal-400 flex items-center justify-center shadow-lg shadow-blue-500/40">
                                        <Bot className="text-white w-8 h-8" />
                                    </div>
                                    <div>
                                        <h5 className="text-white font-bold">TripBot AI</h5>
                                        <p className="text-teal-400 text-xs font-bold uppercase tracking-widest">Online Now</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/10 p-5 rounded-3xl rounded-tl-none mr-12 text-gray-200 text-sm font-medium leading-relaxed border border-white/5">
                                        Tuyệt vời! Bạn nên bắt đầu từ bãi biển Trần Phú và ghé phố hải sản Tháp Bà lúc 19h...
                                    </div>
                                </div>

                                <div className="mt-10 pt-8 border-t border-white/10 flex gap-4">
                                    <div className="h-14 flex-grow bg-white/5 rounded-2xl border border-white/10" />
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-48 text-center pb-32">
                ...
                <h2 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 leading-tight tracking-tighter">Địa danh biểu tượng</h2>
